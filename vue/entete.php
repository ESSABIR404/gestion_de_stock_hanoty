...
<body>
    ...
    <div class="sidebar hidden-print">
        ...
        <img style="margin-left: 10PX;" width="48" height="48" src="https://img.icons8.com/quill/100/FFFFFF/conference-call.png" alt="conference-call"/>
            <span style="margin-left: 10PX;" class="logo_name">H-anoty</span>
        </div>
        <ul class="nav-links">
            <li>
    ...
    <section class="home-section">
        <nav class="hidden-print">
            ...
            <div class="profile-details">
                ...
                <span class="admin_name">ESSABIR</span>
